...
Le **RGPD**, comme la **loi Informatique et Libertés**, précise les conditions dans lesquelles une entreprise, une association, une organisation publique ou une collectivité territoriale peut traiter des données personnelles.

Ces conditions sont appelées les **règles d’or**. Elles constituent le cœur du règlement et peuvent être résumées en **quatre bons réflexes** :
...
Ces règles constituent à la fois :
- un **gage de sécurité juridique** pour les responsables de traitement ;
- un **cadre de confiance** pour les personnes concernées (clients, patients, salariés, usagers, administrés, etc.).
...
- la liste des personnes habilitées à accéder aux données.

### 1.1 La raison d’être du traitement

L’objectif poursuivi doit être :
- clair ;
- précis ;
- licite ;
- déterminé à l’avance.

Tout traitement de données doit répondre à un **objectif précisément déterminé et légitime**.  
Le RGPD prévoit que **toute finalité soit déterminée et explicite**.

### 1.1.2 La légitimité de la finalité

La légitimité de la finalité s’apprécie au regard :
- des règles de droit en vigueur (article 1er de la loi Informatique et Libertés et article 6 du RGPD) ;
- des normes professionnelles ;
- des principes éthiques.

---

## 1.2. Le détournement de finalité

Le **détournement de finalité** consiste à utiliser des données collectées pour un but précis à d’autres fins, **sans l’accord de la personne concernée**.
...
## 1.3. L’évolution des usages sans détournement de finalité

### 3.1 La finalité compatible

Le principe de finalité n’interdit pas l’évolution des usages, à condition que ces évolutions soient **compatibles avec la finalité initiale**.

Le RGPD reconnaît trois finalités compatibles par principe :
1. le traitement à des fins archivistiques dans l’intérêt public ;
2. le traitement à des fins de recherche scientifique ou historique ;
3. le traitement à des fins statistiques.

D’autres finalités peuvent être considérées comme compatibles, à condition qu’elles soient évaluées par l’organisme à l’aide de la **méthode du faisceau d’indices**.

---

### 1.3.2 La méthode du faisceau d’indices

Cette méthode permet de déterminer si une nouvelle finalité est compatible avec la finalité initiale.  
Elle repose sur **quatre critères** :

1. le lien entre la finalité initiale et la nouvelle finalité ;
2. le contexte dans lequel les données ont été collectées ;
3. la nature des données collectées ;
4. les attentes raisonnables des personnes concernées.

---

## 1.4. Le consentement et le fondement juridique

En dehors des cas de **finalité compatible**, il est possible de définir une nouvelle finalité uniquement si **deux conditions cumulatives** sont réunies :

1. le responsable de traitement obtient le **consentement** de la personne concernée ;
2. le nouvel usage des données repose sur une **disposition du droit de l’Union européenne ou du droit de l’État membre**.

---

## Synthèse

La finalité définit le **lien entre les données, les traitements et les organismes** qui traitent les données personnelles.  
Elle constitue le **pilier du traitement des données personnelles**.

Le principe de finalité n’interdit pas l’évolution des usages, à condition que ces évolutions soient compatibles avec la finalité initiale.  
Sous réserve du respect des autres règles du RGPD, le responsable de traitement peut **adapter les finalités initiales**.
...
6. La poursuite des intérêts légitimes du responsable de traitement

### 3.1 Le consentement

Le consentement est la manifestation de volonté, libre, spécifique, éclairée et univoque par laquelle la personne concernée accepte le traitement de ses données personnelles. Il permet ainsi de  : 
-  choisir sans contrainte d'accepter ou de refuser le traitement de ses données personnelles 
...
#### 3.1.1 Le consentement des mineurs
La RGPD protèges les mineurs en dessous de 15ans car ils ne peuvent pas être respondante des données personnelles qu'ils fournissent.

#### 3.1.2 La preuve du consentement
Le responsable de traitement doit être en mesure de prouver qu'il a obtenu le consentement de la personne concernée. Le document doit s'appuyer sur :
- mise en place d'un systeme d'enregistrement du consentement
- séparation claire et intélligible des différente finalités
- bonne information de la personne concernée
- caractère positif et expression du choix de la personne

#### 3.1.3 Consentenment Receuilli avant le RGPD

Le consentement receuilli avant le RGPD est valable si il respecte les conditions du RGPD.

---------
### 3.2 L'exécution d'un contrat

Le traitement est nécessaire à l'exécution d'un contrat auquel la personne concernée est partie ou à l'exécution de mesures précontractuelles prises à la demande de celle-ci.
**LA NECESSITE CONTRACTUELLE**
On 02 cas bien précis :
- l'exécution d'un contrat
- l'exécution de mesures précontractuelles

### 3.3 Le respect d'une obligation légale

Le traitement est nécessaire au respect d'une obligation légale à laquelle le responsable du traitement est soumis.
Défie par le réglement européen doit être un texte du droit de l'union européenne ou du droit de l'état membre.
Au niveau législatif, il peut s'agir d'une loi, d'un décret, d'un arrêté, etc.

### 3.4 La sauvegarde des intérêts vitaux de la personne concernée

Le traitement est nécessaire à la sauvegarde des intérêts vitaux de la personne concernée ou d'une autre personne physique.

### 3.5 L'exécution d'une mission d'intérêt public
